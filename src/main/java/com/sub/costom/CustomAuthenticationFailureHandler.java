...
public class CustomAuthenticationFailureHandler implements AuthenticationFailureHandler {
	...
	public CustomAuthenticationFailureHandler(){
		...
		this.defaultFailureUrl = "/index?result=faile";
	...
	public String toString() {
		return "CustomAuthenticationFailureHandler [logger=" + logger + ", loginidname=" + loginidname
				+ ", loginpasswdname=" + loginpasswdname + ", loginredirectname=" + loginredirectname
				+ ", exceptionmsgname=" + exceptionmsgname + ", defaultFailureUrl=" + defaultFailureUrl + "]";
	}
